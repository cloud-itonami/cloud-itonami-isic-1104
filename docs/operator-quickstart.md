# Operator Quickstart — Soft Drink and Bottled Water Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1104** (`cloud-itonami-isic-1104`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1104.git
cd cloud-itonami-isic-1104
```
...
- Blueprint governor key: `softdrinkops-governor`
- Likely source path: `softdrinkops.governor.cljc`
